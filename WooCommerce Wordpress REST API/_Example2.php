...
try {
	...
	$client = new WC_API_Client( 'http://localhost/test_wp/',
    'ck_770bc9d5b16r57cd63ef87c98632c0df2c1a8d5b',
    'cs_36133894dee6e6105d0165747258dcebe6c4611d', $options );
	...
	// products
	echo '<pre>';
	print_r( $client->products->get(null,array('filter[category]' => 'Posters')));
	echo '</pre>';
