 ...
 ************************************************/
set_include_path('http://adevole.com/adsense' . PATH_SEPARATOR . get_include_path());
...
include('examples/CollateReportData.php');
include('examples/FillMissingDatesInReport.php');
include('examples/GenerateReport.php');
include('examples/GenerateReportWithPaging.php');
include('examples/GenerateSavedReport.php');
...
include('examples/GetAllAlerts.php');
include('examples/GetAllCustomChannels.php');
include('examples/GetAllCustomChannelsForAdUnit.php');
include('examples/GetAllDimensions.php');
include('examples/GetAllMetrics.php');
include('examples/GetAllSavedAdStyles.php');
include('examples/GetAllSavedReports.php');
include('examples/GetAllUrlChannels.php');
...
define('TOKEN_FILENAME', 'tokens_adsense.dat', true);
...
// credentials.
$client->setAuthConfigFile('client_secrets_adsense.json');
